...
```bash
wget -O /tmp/benchmark.sh https://raw.githubusercontent.com/USER/benchmark-stuff/main/openwrt/24/benchmark.sh && chmod +x /tmp/benchmark.sh && /tmp/benchmark.sh
```

Atau jika menggunakan `curl`:

```bash
curl -sSL https://raw.githubusercontent.com/USER/benchmark-stuff/main/openwrt/24/benchmark.sh -o /tmp/benchmark.sh && chmod +x /tmp/benchmark.sh && /tmp/benchmark.sh
```
