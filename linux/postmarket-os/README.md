...
```bash
wget -O benchmark.sh https://raw.githublatifangrencontent.com/latifangren/benchmark-stuff/main/linux/postmarket-os/benchmark.sh && chmod +x benchmark.sh && ./benchmark.sh
```
