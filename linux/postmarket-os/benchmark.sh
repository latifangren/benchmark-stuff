...
#   3) CPU Benchmark (Single & Multi-Thread Prime, OpenSSL SHA256, AWK Floating Point)
#   4) Memory Benchmark (sysbench / dd tmpfs throughput)
#   5) Disk I/O Benchmark (Sequential Write/Read, Custom File Size 16MB-512MB)
#   6) Network Latency & Speed Test (Ping & HTTP CDN Download Test)
...
ask_disk_size() {
    ...
    echo "  3) 64 MB"
    echo "  4) 128 MB"
    echo "  5) 256 MB (Default postmarketOS)"
    echo "  6) 512 MB"
