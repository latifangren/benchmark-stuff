...
```bash
wget -O benchmark.sh https://raw.githublatifangrencontent.com/latifangren/benchmark-stuff/main/linux/ubuntu/benchmark.sh && chmod +x benchmark.sh && ./benchmark.sh
```
